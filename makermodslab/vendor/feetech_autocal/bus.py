...
`FeetechMotorsBus` via a mixin. MakerMods Lab tracks upstream lerobot, so instead of
patching lerobot we compose the vendored mixin with MakerMods Lab's *upstream*
